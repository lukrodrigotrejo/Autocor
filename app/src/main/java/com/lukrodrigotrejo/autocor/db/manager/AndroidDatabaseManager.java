package com.lukrodrigotrejo.autocor.db.manager;//add your package name here example: package com.example.dbm;
...
public class AndroidDatabaseManager extends Activity implements OnItemClickListener {
    ...
    static class indexInfo
    {
        ...
        private static int cursorpostion=0;
        private static List<String> value_string;
        private static List<String> tableheadernames;
        private static List<String> emptytablecolumnnames;
        private static boolean isEmpty;
        private static boolean isCustomQuery;
    }
...
// all global variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitQuery.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if("Success".equalsIgnoreCase(Message2.getString(0)))
                {
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if(pos!=0){
                    ...
                    List<Cursor> alc2=dbm.getData(Query2);
                    ...
                    if(c2!=null)
                    {
                        ...
                        spinnertable.setOnItemSelectedListener((new OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                ...
                                if("Drop this table".equals(spinnertable.getSelectedItem().toString()))
                                {
                                                        ...
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        List<Cursor> aldropt=dbm.getData(Query6);
                                                                        Cursor tempc=aldropt.get(1);
                                                                        tempc.moveToLast();
                                                                        Log.d("Drop table Mesage",tempc.getString(0));
                                                                        if("Success".equalsIgnoreCase(tempc.getString(0)))
                                                                        {
                                                                            tvmessage.setBackgroundColor(Color.parseColor("#2ecc71"));
                                ...
                                //when user selects to drop the table the below code in if block will be executed
                                if("Delete this table".equals(spinnertable.getSelectedItem().toString()))
                                {	// an alert dialog to confirm user selection
                                    runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                                        ...
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        List<Cursor> aldeletet=dbm.getData(Query7);
                                ...
                                if("Add row to this table".equals(spinnertable.getSelectedItem().toString()))
                                {
                                    ...
                                    final List<TextView> addnewrownames = new LinkedList<TextView>();
                                    final List<EditText> addnewrowvalues = new LinkedList<EditText>();
                                                        ...
                                                        .setPositiveButton("Add",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        List<Cursor> altc=dbm.getData(Query4);
    ...
    {
        List<Cursor> alc3=dbm.getData("PRAGMA table_info("+indexInfo.table_name+")");
        ...
        if(c5!=null)
        {
            ...
            List<String> emptytablecolumnnames= new ArrayList<String>();
            c5.moveToFirst();
            do
            {
                emptytablecolumnnames.add(c5.getString(1));
            }while(c5.moveToNext());
            setEmptyTableColumnNames(emptytablecolumnnames);
        }
    ...
    public void updateDeletePopup(int row)
    {
        ...
        final List<String> value_string = indexInfo.value_string;
        final List<TextView> columnames = new LinkedList<TextView>();
        final List<EditText> columvalues = new LinkedList<EditText>();
                            ...
                            .setPositiveButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            if("Update this row".equalsIgnoreCase(spinner_value))
                                            {
                                                setIndex(10);
                                                ...
                                                for(int i=0;i<columnames.size();i++)
                                                {
                                                    ...
                                                    if(!"null".equals(etc.getText().toString()))
                                                    {
                                                ...
                                                {
                                                    TextView tvc = columnames.get(i);
                                                    if(!"null".equals(value_string.get(i)))
                                                    {
                                                ...
                                                //dbm.getData(Query3);
                                                List<Cursor> aluc=dbm.getData(Query3);
                                            ...
                                            if("Delete this row".equalsIgnoreCase(spinner_value))
                                            {
                                                setIndex(10);
                                                ...
                                                List<Cursor> aldc=dbm.getData(Query5);
    ...
    public void refreshTable(int d )
    {
        ...
        if(d==0)
        {
            ...
            List<Cursor> alc3=dbm.getData(Query8);
            c3=alc3.get(0);
            //saving cursor to the static indexinfo class which can be resued by the other functions
            setMainCursor(c3);
        }
    ...
    public void paginatetable(final int number)
    {
        ...
        setNumberOfPages((c3.getCount()/10) + 1);
        setCurrentPage(1);
        c3.moveToFirst();
        int currentrow=0;
        ...
        do
        {
            ...
            tableRow.setOnClickListener(new OnClickListener(){
                public void onClick(View v) {
                    ...
                    final List<String> value_string = new ArrayList<String>();
        ...
        previous.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    setCurrentPage(indexInfo.currentpage - 1);
    ...
    public static int getIndex() {return indexInfo.index;}

    public static void setNumberOfPages(int numberofpages) { indexInfo.numberofpages = numberofpages; }

    public static int getNumberOfPages() {return indexInfo.numberofpages;}

    public static void setCurrentPage(int currentPage) { indexInfo.currentpage = currentPage; }

    public static int getCurrentPage() {return indexInfo.currentpage;}

    public static void setTableName(String table_name) { indexInfo.table_name = table_name; }

    public static String getTableName() {return indexInfo.table_name;}

    public static void setMainCursor(Cursor maincursor) { indexInfo.maincursor = maincursor; }

    public static Cursor getMainCursor() {return indexInfo.maincursor;}

    public static void setCursorPostion(int cursorpostion) { indexInfo.cursorpostion = cursorpostion; }

    public static int getCursorPosition() {return indexInfo.cursorpostion;}

    public static void setValueString(List<String> value_string) { indexInfo.value_string = value_string; }

    public static List<String> getValueString() {return (ArrayList)indexInfo.value_string;}

    public static void setEmptyTableColumnNames(List<String> emptytablecolumnnames) {indexInfo.emptytablecolumnnames = emptytablecolumnnames;}

    public static List<String> getEmptyTableColumnNames() {return (ArrayList)indexInfo.emptytablecolumnnames;}

    public static void setIsEmpty(boolean isEmpty) { indexInfo.isEmpty = isEmpty; }

    public static boolean getIsEmpty() {return indexInfo.isEmpty;}

    public static void setIsCustomQuery(boolean isCustomQuery) { indexInfo.isCustomQuery = isCustomQuery; }

    public static boolean getIsCustomQuery() {return indexInfo.isCustomQuery;}
}
